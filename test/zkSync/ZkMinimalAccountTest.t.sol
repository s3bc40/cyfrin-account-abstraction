...
contract ZkMinimalAccountTest is Test {
    ...
    /*===============================================
                     Helpers          
    ===============================================*/
    // @notice done inside helper since we can not script it
    ...
    function _signTransaction(Transaction memory transaction) internal view returns (Transaction memory) {
        ...
        bytes32 r;
        bytes32 s;
        uint256 ANVIL_DEFAULT_KEY = 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80; // hardcoded private key
